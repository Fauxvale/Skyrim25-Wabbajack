...
2. **Get Skyrim25:**
   - Method 1 (from Wabbajack): Open Wabbajack, click "Browse Lists", check the "Non-featured" box, then search for "Skyrim25".
...
**Simon Magus' Discord** - For being a positive place to hang out, learn to mod and get great feedback on this list.
